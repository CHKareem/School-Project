...
export default {
    ...
    data:()=>({
        ...
        methods:{
          ...
          add_row(){
            this.subjects_array.push(new Subject(-1, this.subjects, this.$root.$data.chosen_class.id, this.hour, JSON.parse(JSON.stringify(this.days)), this.day_checked, this.optional_checked, this.weight_value));
